...
1. Open a private [GitHub Security Advisory](https://github.com/GrayCodeAI/hawk-sdk-go/security/advisories/new), **or**
...
- LLM provider services that hawk-sdk-go integrates with (report to the
  provider).
- Local filesystem misuse where an attacker already has shell access (out of
  threat model).

For hawk-sdk-go-specific threat-model notes, see the README and any docs in
this repo.
